...
A conversational AI assistant that uses speech-to-text and text-to-speech capabilities, powered by Groq's fast LLM. The assistant is designed to be witty and engaging, providing humorous responses in a natural, conversational style.
...
- 🤖 Powered by Groq's fast LLM for intelligent responses
